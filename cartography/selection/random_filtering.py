...
if __name__ == "__main__":
    ...
    input_train_file = os.path.join(args.data_dir, "train.tsv")
    try:
        ...
        train_dict, train_header = read_data(
            input_train_file, task_name=args.task_name)
        train = convert_tsv_entries_to_dataframe(
            train_dict, header=train_header)
    ...
    for fraction in fractions:
        ...
        copy_dev_test(args.task_name, from_dir=args.data_dir, to_dir=outdir)
